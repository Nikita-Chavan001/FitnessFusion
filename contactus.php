  ...
  <div class="container mx-auto">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="workout.html" style="font-size: 18px;">Workouts</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Membership.html" style="font-size: 18px;">Membership</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="gellery.html" style="font-size: 18px;">Gallery</a>
        </li>
        <li class="nav-item active">
            <a class="nav-link" href="contactus.html" style="font-size: 18px;">Contact Us</a>
          </li>
        <li class="nav-item">
          <a class="nav-link" href="about.html" style="font-size: 18px; ">About Us</a>
        </li>
  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      ...
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="embed-responsive-item" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3861.735201378718!2d-122.08439948461835!3d37.421999979817496!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80858079f1e7d051%3A0x92105a9cd19a00c8!2sGolden%20Gate%20Bridge!5e0!3m2!1sen!2sus!4v1638263202539!5m2!1sen!2sus" allowfullscreen></iframe>
      </div>
    </div>
  </div>
</section>
...
<footer class="text-center text-lg-start bg-body-tertiary text-muted" style="color: white;">
      ...
      <div class="container text-center text-md-start mt-5" style="color: white;">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="Membership.html" class="text-reset">Memberships</a>
            </p>
            <p>
              <a href="#!" class="text-reset">Facilities</a>
            </p>
            <p>
              <a href="gellery.html" class="text-reset">Gallery</a>
            </p>
            <p>
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05); color:#fff ">
      © 2024 Copyright:
      <a class="text-reset fw-bold" style="color: white;" href="https://mdbootstrap.com/">FitnessFusion.com</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
