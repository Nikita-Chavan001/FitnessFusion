      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link" href="#about-gym" style="font-size: 18px">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#about-team" style="font-size: 18px">Workouts</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#sponsors" style="font-size: 18px">Membership</a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="#sponsors" style="font-size: 18px">Gallery</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#sponsors" style="font-size: 18px">Contact Us</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#sponsors" style="font-size: 18px">About Us</a>
          </li>
        </ul>
      </div>
    </div>
