      ...
      <div class="container mx-auto">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="Home.html" style="font-size: 18px"
                >Home</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link" href="workout.html" style="font-size: 18px"
                >Workouts</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link" href="Membership.html" style="font-size: 18px"
                >Membership</a
              >
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="gellery.html" style="font-size: 18px"
                >Gallery</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link" href="contactus.html" style="font-size: 18px"
                >Contact Us</a
              >
            </li>
            <li class="nav-item">
        ...
        <?php
          ...
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              ...
              echo '<img src="assets/dot-bg.png" alt="bg" class="class__bg" />';
